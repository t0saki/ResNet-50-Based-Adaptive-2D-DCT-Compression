  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 4:
      {
        if (strcmp(instanceChksum, "shVlAhH9z2UAG9LfutEzQFC") == 0) {
     ...
     case 7:
      {
        if (strcmp(instanceChksum, "siTH6ZH6v6WLkpwBM7pPo9C") == 0) {
  ...
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 4:
      {
        if (strcmp(tpChksum, "shVlAhH9z2UAG9LfutEzQFC") == 0) {
     ...
     case 7:
      {
        if (strcmp(tpChksum, "siTH6ZH6v6WLkpwBM7pPo9C") == 0) {
