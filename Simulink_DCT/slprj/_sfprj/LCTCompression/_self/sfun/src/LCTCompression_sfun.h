#ifndef __LCTCompression_sfun_h__
#define __LCTCompression_sfun_h__
...
extern mxArray* load_LCTCompression_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_LCTCompression_optimization_info(void);
